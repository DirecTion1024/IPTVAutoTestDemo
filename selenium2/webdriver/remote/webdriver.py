...
from selenium2.webdriver.common.html5.application_cache import ApplicationCache
...
class WebDriver(object):
    ...
    def page_source(self):
        ...
        :Usage:
            driver.page_source
        """
        print Command.GET_PAGE_SOURCE
        print self.execute(Command.GET_PAGE_SOURCE)
